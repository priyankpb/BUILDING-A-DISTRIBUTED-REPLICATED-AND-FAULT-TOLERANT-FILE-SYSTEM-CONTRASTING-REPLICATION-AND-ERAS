...
public class ChunkServerMajorHeartbeat implements Event {
    ...
    private int nodeID;
    private byte[] data;
    private Map<String, Map<Integer, Integer[]>> metaDataCache = new HashMap<>();
    ...
    public Map<String, Map<Integer, Integer[]>> getMetaDataCache() {
        return metaDataCache;
    }

    public void setMetaDataCache(Map<String, Map<Integer, Integer[]>> metaDataCache) {
