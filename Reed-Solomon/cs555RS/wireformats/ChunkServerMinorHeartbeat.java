...
public class ChunkServerMinorHeartbeat implements Event {

    private byte type = Protocol.CHUNKSERVER_MINOR_HEARTBEAT;

    private int nodeID;
    private byte[] data;
//    private Map<String, MetaData> metaDataCache = new HashMap<>();

    ChunkServerMinorHeartbeat() {
    }
...
//    }
    ...
    public ChunkServerMinorHeartbeat(byte[] data) throws IOException {
