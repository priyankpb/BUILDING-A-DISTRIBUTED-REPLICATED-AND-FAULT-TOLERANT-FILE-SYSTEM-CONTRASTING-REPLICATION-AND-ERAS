...
public class ChunkServerChunkServer2 implements Event {

    private byte type = Protocol.CHUNKSERVER_CHUNKSERVER2;
    ...
    public ChunkServerChunkServer2() {
    }

    public ChunkServerChunkServer2(byte[] data) throws IOException {
